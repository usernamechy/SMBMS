...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${pageContext.request.contextPath }/bill/bill.do">
			<span>商品名称：</span>
			<input name="queryProductName" type="text" value="${queryProductName }">
			 
			<span>供应商：</span>
            <input type="hidden" id="proid" value="${queryProviderId}">
			<select name="queryProviderId" id="billProvider"></select>
